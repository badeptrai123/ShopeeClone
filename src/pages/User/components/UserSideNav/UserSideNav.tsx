  ...
  return (
    <div>
      <div className='flex border-b border-b-gray-200 py-4'>
        <Link to='' className='h-7 w-7 flex-shrink-0 overflow-hidden rounded-full border border-black/10'>
      ...
      <div className='mt-6'>
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            classNames('mt-3 flex items-center capitalize transition-colors hover:text-orange', {
              'text-orange': isActive,
              'text-gray-600': !isActive
            })
          }
